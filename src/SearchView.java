...
public class SearchView extends JPanel {
    ...
    private SearchView()
    {
        ...
        //allows user to search by title by hitting enter
        ...
        //allows user to search by description by hitting enter
        KeyAdapter description = new KeyAdapter()
        {
            @Override
            public void keyPressed(KeyEvent e)
            {
                if (e.getKeyCode() == KeyEvent.VK_ENTER)
                {
                    searchByDescription.doClick();
                }
            }
        };

        enterRating.addKeyListener(description);
        enterDirector.addKeyListener(description);
        enterYear.addKeyListener(description);
        enterGenre.addKeyListener(description);
        enterActor.addKeyListener(description);
